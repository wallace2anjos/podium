<!DOCTYPE html>
<html lang="en">
    <!-- Mirrored from themes.startbootstrap.com/sb-ui-kit-pro/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Mar 2020 12:52:11 GMT -->
<head>
        <meta charset="utf-8" />
            ...
            <div id="layoutDefault_content">
                <main>
                    <nav class="navbar navbar-marketing navbar-expand-lg bg-white navbar-light">
                        <div class="container">
                            <a class="navbar-brand text-dark" href="index-2.html">SB UI Kit Pro</a><button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><i data-feather="menu"></i></button>
                                                ...
                                                <div class="col-lg-5 p-lg-3 bg-img-cover overlay overlay-primary overlay-70 d-none d-lg-block" style='background-image: url("https://source.unsplash.com/mqO0Rf-PUMs/500x350")'>
                                                    <div class="d-flex h-100 w-100 align-items-center justify-content-center">
                                                        <div class="text-white text-center z-1">
                                                            ...
                                                            <a class="btn btn-white btn-sm text-primary rounded-pill" href="index-2.html">View All</a>
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <section class="bg-white border-bottom py-10">
                        <div class="container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6 text-lg-right"><a class="btn btn-marketing btn-primary rounded-pill mr-3" href="#!">Start Now</a><a class="btn btn-marketing btn-transparent-dark rounded-pill" href="#!">Contact Us</a></div>
                            </div>
                        </div>
                    </section>
                </main>
...
<!-- Mirrored from themes.startbootstrap.com/sb-ui-kit-pro/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 24 Mar 2020 12:52:30 GMT -->
</html>
